...
- Архитектурная разработка проектов, руководство командами разработчиков в телекоме (биллинг, ЛК, статистика). Методология C4model/structurizr, ведение архитектурного репозитория организации, архитектурных контроль команд.
